...
//       </header>
//       <div className="dashboard-container">
//         <InputDashboard className="input-dashboard" sendTask={sendTask} />
//         <OutputDashboard className="output-dashboard" messages={messages} />
//       </div>
  ...
  return (
    <div>
      ...
      <div className="app-container">
        ...
        {/* שינוי מיקום הכותרת ל-Task Flow מעל הגרף */}
        <div className="chart-container">
          <h2 className="graph-title">Task Flow</h2>
          <TaskGraph data={generateChartData()} />
        </div>
      </div>
    </div>
